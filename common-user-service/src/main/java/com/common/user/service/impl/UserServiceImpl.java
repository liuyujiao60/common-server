...
import com.common.user.contant.RedisContant;
import com.common.user.contant.UserExceptionEnums;
import com.common.user.dao.UserBasicInfoMapper;
import com.common.user.entity.UserBasicInfo;
...
public class UserServiceImpl implements UserService {
    ...
    public boolean accountExistCheck(UserBasicInfoVo userVo) {
        ...
        if(userVo==null||StringUtils.isEmpty(userVo.getAccount())){
            throw new ServerException(UserExceptionEnums.USER_PARAM_ERROR,null);
        }
